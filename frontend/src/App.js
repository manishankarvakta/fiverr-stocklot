...
import { 
  ...
  CheckCircle, XCircle, AlertTriangle, Filter, SortAsc, Home, Building, User, Settings, 
  ...
  LayoutDashboard, MessageCircle, Ban, Check, Copy, Heart, Award, Truck
} from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            <Link 
              to="/how-it-works" 
              className={`font-medium transition-colors hover:text-emerald-700 ${
                location.pathname === '/how-it-works' ? 'text-emerald-700' : 'text-gray-600'
              }`}
            >
              How It Works
            </Link>
...
function BuyRequestsPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-emerald-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-emerald-700">Please log in to view buy requests</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-emerald-100">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-emerald-900 mb-2">Buy Requests</h1>
          <p className="text-emerald-700">Browse livestock buy requests from buyers</p>
        </div>
