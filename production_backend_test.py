...
class StockLotProductionTester:
    def __init__(self, base_url="https://buy-request-fix.preview.emergentagent.com/api"):
    ...
    def test_paystack_payment_system(self):
        ...
        payment_data = {
            ...
            "callback_url": "https://buy-request-fix.preview.emergentagent.com/payment-callback"
        }
