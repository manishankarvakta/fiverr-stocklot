...
- **Issue**: The domain `https://easy-signin-1.preview.emergentagent.com` is not authorized in your Google OAuth client settings
...
6. **Add Authorized Redirect URIs**:
   ```
   https://easy-signin-1.preview.emergentagent.com/auth/google/callback
