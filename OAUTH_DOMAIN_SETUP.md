...
- **Issue**: The domain `https://buy-request-fix.preview.emergentagent.com` is not authorized in your Google OAuth client settings
...
6. **Add Authorized Redirect URIs**:
   ```
   https://buy-request-fix.preview.emergentagent.com/auth/google/callback
