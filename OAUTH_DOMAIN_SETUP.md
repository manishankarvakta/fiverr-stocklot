...
- **Issue**: The domain `https://email-system-test.preview.emergentagent.com` is not authorized in your Google OAuth client settings
...
6. **Add Authorized Redirect URIs**:
   ```
   https://email-system-test.preview.emergentagent.com/auth/google/callback
