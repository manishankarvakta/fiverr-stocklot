...
async def send_welcome_email(db, user_id: str, user_name: str, user_email: str):
    ...
    await service.send_notification(
        ...
        channels=[NotificationChannel.EMAIL, NotificationChannel.IN_APP],
        action_url="https://farmstock-2.preview.emergentagent.com/marketplace",
        template_data={
            "user_name": user_name,
...
async def send_order_confirmation(db, user_id: str, order_data: Dict):
    ...
    await service.send_notification(
        ...
        channels=[NotificationChannel.EMAIL, NotificationChannel.IN_APP],
        action_url=f"https://farmstock-2.preview.emergentagent.com/orders/{order_data['order_id']}",
        template_data={
...
async def send_login_alert(db, user_id: str, user_name: str, device_info: str, location: str):
    ...
    await service.send_notification(
        ...
        channels=[NotificationChannel.EMAIL, NotificationChannel.IN_APP], 
        action_url="https://farmstock-2.preview.emergentagent.com/account/security",
        template_data={
            "user_name": user_name,
